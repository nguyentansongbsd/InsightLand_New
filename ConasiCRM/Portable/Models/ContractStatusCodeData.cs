...
namespace ConasiCRM.Portable.Models
{
    public class ContractStatusCodeData
    {
        public static List<StatusCodeModel> ContractStatusData()
        {
            ...
            {
                new StatusCodeModel("100000001","1st Installment","#F43927"), // thanh toán đợt 1
                new StatusCodeModel("100000003","Being Payment","#F43927"),
                new StatusCodeModel("4","Canceled","#8bce3d"), // đã hủy
                new StatusCodeModel("100001","Complete","#FF8F4F"), // hoàn thành
                ...
                new StatusCodeModel("100000002","Signed Contract","#FF8F4F"), // đã ký hợp đồng
                new StatusCodeModel("100000006","Terminated","#c4c4c4"), // đã thanh lý
