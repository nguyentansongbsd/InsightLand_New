...
namespace ConasiCRM.Portable.Views
{
    public partial class UserInfoPage : ContentPage
    {
        ...
        private async void ConfirmContactAddress_Clicked(object sender, EventArgs e)
        {
            ...
            viewModel.ContactModel._bsd_country_value = (Guid)(viewModel.AddressCountryContact?.Id);
            viewModel.ContactModel.bsd_country_label = viewModel.AddressCountryContact?.Name;
            viewModel.ContactModel._bsd_province_value = (Guid)(viewModel.AddressStateProvinceContact?.Id);
            viewModel.ContactModel.bsd_province_label = viewModel.AddressStateProvinceContact?.Name;
            viewModel.ContactModel._bsd_district_value = (Guid)(viewModel.AddressCityContact?.Id);
