        ...
        public async Task LoadHandoverConditions()
        {
            string fetchXml = $@"<fetch version='1.0' output-format='xml-platform' mapping='logical' distinct='false'>
                                  <entity name='bsd_packageselling'>
                                    ...
                                    <filter type='and'>
                                      <condition attribute='bsd_phaseslaunch' operator='eq' uitype='bsd_phaseslaunch' value='{PhasesLaunchId}' />
                                    </filter>
                                  </entity>
                                </fetch>";
        ...
        public async Task LoadSalesAgent()
        {
            string fetchphaseslaunch = $@"<fetch version='1.0' output-format='xml-platform' mapping='logical' distinct='false'>
                              <entity name='bsd_phaseslaunch'>
                                ...
                                <order attribute='bsd_name' descending='true' />
                                <filter type='and'>
                                    <condition attribute='bsd_phaseslaunchid' operator='eq' value='{Quote._bsd_phaseslaunchid_value}' />
                                </filter>
