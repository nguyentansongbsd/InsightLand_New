...
namespace ConasiCRM.Portable.Helper
{
    public class LoginHelper
    {
        ...
        {
            var client = BsdHttpClient.Instance();
            var request = new HttpRequestMessage(HttpMethod.Post, "https://login.microsoftonline.com/b8ff1d2e-28ba-44e6-bf5b-c96188196711/oauth2/token" );//"https://login.microsoftonline.com/common/oauth2/token"
            var formContent = new FormUrlEncodedContent(new[]
                {
                        //new KeyValuePair<string, string>("client_id", "2ad88395-b77d-4561-9441-d0e40824f9bc"),
